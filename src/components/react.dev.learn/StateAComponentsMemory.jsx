...
export default function StateAComponentsMemory() {
    ...
    const task1 = <>
        <button onClick={handlePrevClick} className='mr-3'>
            Prev
        </button>
    ...
    const task2 = <>
        <form onSubmit={e => e.preventDefault()}>
            ...
            <button onClick={handleReset} className='border border-black'>Reset</button>
        </form>
    </>
    ...
    const task3 = <>
        {isSent ?
            ...
            (<form onSubmit={e => {
                ...
                />
                <br />
                <button type="submit" className='border border-black'>Send</button>
            </form>)
        }
    </>
